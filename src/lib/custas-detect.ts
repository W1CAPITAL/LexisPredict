...
const RE_ALTA =
  /CUSTAS?\s+(INICIAIS|FINAIS|PROCESSUAIS)|RECOLHIMENTO\s+DE\s+CUSTAS|GUIA\s+DE\s+CUSTAS|PREPARO\s+RECURSAL|TAXA\s+JUDICI[AÁ]RIA|COMPLEMENTO\s+DE\s+CUSTAS|INTIMA[CÇ][AÃ]O\s+PARA\s+RECOLHER/i;
