 ...
 * CATÁLOGO DE SCRIPTS DE GABINETE v1.7 - PROTOCOLO DE PRECISÃO
 */
...
export const SCRIPT_CATALOG: ScriptTemplate[] = [
  ...
  },
  {
    ...
    texto: 'Olá, [Nome]! Informamos que o tribunal designou uma data para audiência no processo [CNJ]. Trata-se de uma etapa do rito processual para tentativa de conciliação ou instrução. Nossa equipe jurídica entrará em contato em breve para passar as instruções, o link de acesso (se virtual) e realizar o preparo necessário.\n\nSetor Processual — Get Assessoria',
  ...
  },
  {
    ...
    texto: 'Olá, [Nome]! O processo [CNJ] avançou para a fase de perícia. O juiz nomeou um perito ou houve a juntada do laudo técnico aos autos. Esta etapa é fundamental para a produção de provas especializadas sobre o contrato. Estamos acompanhando os prazos para manifestação técnica.\n\nSetor Processual — Get Assessoria',
  ...
  },
  {
    ...
    texto: 'Olá, [Nome]! O juizo proferiu uma nova decisão nos autos do processo [CNJ]. Nossa equipe jurídica já foi notificada e está analisando o teor técnico do despacho para dar andamento às providências de gabinete necessárias. Retornaremos com o parecer em breve.\n\nSetor Processual — Get Assessoria',
  ...
  },
  {
    ...
    texto: 'Oi, [Nome]! Houve o decurso de prazo no processo [CNJ]. Isso significa que o tempo para uma das partes se manifestar encerrou. Nossa equipe está conferindo o impacto desse encerramento e aguardando o próximo andamento automático do cartório.\n\nSetor Processual — Get Assessoria',
    quandoUsar: 'Usar quando houver decurso de prazo sem outras prioridades.',
