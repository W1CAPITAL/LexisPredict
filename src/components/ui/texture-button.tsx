    ...
    return (
      <Button
        ...
        className={cn(
          ...
          "before:pointer-events-none before:absolute before:inset-0 before:opacity-[0.12]",
          "before:bg-[radial-gradient(circle_at_30%_20%,rgba(255,255,255,0.9),transparent_45%),repeating-linear-gradient(0deg,transparent,transparent_2px,rgba(0,0,0,0.03)_2px,rgba(0,0,0,0.03)_3px)]",
          textureVariant === "accent" &&
