...
export function DataJudScannerPanel() {
  ...
  return (
    <div className={cn("fixed bottom-6 right-6 z-[200] w-[420px] bg-white border-2 border-black shadow-[12px_12px_0px_rgba(0,0,0,0.1)] transition-all animate-in slide-in-from-bottom-4")}>
      ...
      <div className="p-6 space-y-6">
        ...
        {status === 'idle' ? (
          ...
          <div className="space-y-6">
            ...
            <ScrollArea className="h-40 border-2 border-black bg-[#fafafa]">
