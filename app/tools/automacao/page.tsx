    ...
    <div className="flex min-h-screen bg-background">
      ...
      <main className="flex-1 p-4 md:p-8 max-w-5xl mx-auto space-y-6 overflow-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          {[
            { n: "1", t: "Consultar o CNJ", d: "Digite 20 dígitos e busque no DJEN — preenche polos, classe e tribunal." },
            { n: "2", t: "Conferir os campos", d: "Revise/complete as informações do cliente e da ação antes de salvar." },
            { n: "3", t: "Salvar na carteira", d: "O processo entra na aba Processos e fica pronto para a Fila de contato." },
          ].map((s) => (
            <div key={s.n} className="rounded-xl border border-border/60 bg-card/60 backdrop-blur-md p-4 flex items-start gap-3">
              <div className="w-8 h-8 rounded-lg bg-primary/10 text-primary flex items-center justify-center font-black text-sm shrink-0">{s.n}</div>
              <div className="min-w-0">
                <p className="text-[11px] font-black uppercase tracking-tight">{s.t}</p>
                <p className="text-[9px] font-bold uppercase text-muted-foreground/70 leading-snug mt-0.5">{s.d}</p>
              </div>
            </div>
          ))}
        </div>
          ...
          <div className="space-y-6">
            ...
            <Card className="border-2 border-black/10">
              <CardHeader className="pb-3">
                ...
                <CardDescription>
                  Quem procura o escritório. Usado na Fila de contato, no WhatsApp e no cadastro do cliente.
                </CardDescription>
              </CardHeader>
              <CardContent className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="sm:col-span-2 space-y-2">
                  <Label className="text-[10px] font-black uppercase">Nome completo <span className="text-red-500">*</span></Label>
                  <Input
                    value={form.cliente}
                    onChange={(e) => setField("cliente", e.target.value.toUpperCase())}
                    className="h-11 rounded-xl font-black uppercase text-xs"
                  />
                  <p className="text-[9px] font-bold uppercase text-muted-foreground/60">Obrigatório — usado como identificação principal do processo.</p>
                </div>
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-[9px] font-bold uppercase text-muted-foreground/60">CPF do cliente (polo ativo).</p>
                </div>
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-[9px] font-bold uppercase text-muted-foreground/60">Usado para contato oficial.</p>
                </div>
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-[9px] font-bold uppercase text-muted-foreground/60">Com DDD — gera o link de WhatsApp na Fila.</p>
                </div>
                <div className="space-y-2">
            ...
            <Card className="border-2 border-black/10">
              <CardHeader className="pb-3">
                ...
                <CardDescription>
                  Contra quem se move (banco/réu) e os dados do processo. Campos "mais recente" são preenchidos pelo DJEN.
                </CardDescription>
              </CardHeader>
              <CardContent className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="sm:col-span-2 space-y-2">
                  ...
                  />
                  <p className="text-[9px] font-bold uppercase text-muted-foreground/60">Instituição financeira / réu citado na ação.</p>
                </div>
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-[9px] font-bold uppercase text-muted-foreground/60">CNPJ do banco/réu, se houver.</p>
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="TJSP"
                  />
                  <p className="text-[9px] font-bold uppercase text-muted-foreground/60">Preenchido automaticamente pelo CNJ.</p>
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  <Label className="text-[10px] font-black uppercase">Advogado polo ativo</Label>
                  <Input
                    value={form.advogado}
                  ...
                  />
                  <p className="text-[9px] font-bold uppercase text-muted-foreground/60">Advogado mais recente do polo do cliente.</p>
                </div>
                <div className="space-y-2">
                  <Label className="text-[10px] font-black uppercase">Advogado polo passivo</Label>
                  <Input
                  ...
                  />
                  <p className="text-[9px] font-bold uppercase text-muted-foreground/60">Advogado mais recente da parte contrária.</p>
                </div>
                <div className="space-y-2">
            ...
            <p className="text-[9px] font-bold uppercase text-muted-foreground/60 text-center">
              Obrigatórios: <span className="text-red-500">CNJ (20 dígitos)</span> e <span className="text-red-500">Nome do cliente</span>. Demais campos podem ser preenchidos depois na aba Processos.
            </p>
          </div>
        )}
